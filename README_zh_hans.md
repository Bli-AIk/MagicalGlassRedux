...
**MagicalGlassRedux** — 面向 [Kristal](https://github.com/KristalTeam/Kristal) 的 UNDERTALE 风格光世界战斗系统：法术与 TP、蓝/绿/紫/黄灵魂、UT 风格商店/存档点/菜单/物品，以及完整的光世界战斗框架（"LightBattle"）。
...
`v0.2.0` 是本 fork 当前在 `lib.json` 中的版本线；本 fork 尚未发布打包版本（见 [`CHANGELOG.md`](CHANGELOG.md)）。
...
完整的光世界战斗框架（"LightBattle"）：光世界敌人、波次与弹幕、FIGHT/MERCY/SPARE 与灵魂弹幕板（蓝/绿/紫/黄）、TP、擦弹与 Defend 指令、多成员光世界战斗、敌人 HP/MERCY 槽与可选的 MERCY 条。
...
- [UndertaleMonstersRecreation](https://github.com/Bli-AIk/UndertaleMonstersRecreation) —— UT 怪物（蛙吉特、小模怪…）光世界战斗内容。
